...
public class AboutUs extends ActionBarActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        String email = null;
        switch (id){
            case R.id.randhirmail: email = getResources().getString(R.string.randhirmail);
                break;
            case R.id.darshanmail: email = getResources().getString(R.string.darshanmail);
                break;
            case R.id.rohanmail: email = getResources().getString(R.string.rohanmail);
                break;
            case R.id.dikshamail: email = getResources().getString(R.string.dikshamail);
                break;
            case R.id.abhishekmail: email = getResources().getString(R.string.abhishekmail);
                break;
            case R.id.arjitmail: email = getResources().getString(R.string.arjitmail);
                break;
            case R.id.antonymail: email = getResources().getString(R.string.antonymail);
        }
