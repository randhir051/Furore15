...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    Context context;
    private String mNavTitles[] = {"Schedule", "Selfie Contest","DJ Night","Social","Developers"};
    private int mIcons[] = {
            R.drawable.ic_action_time, R.drawable.ic_action_camera,
            R.drawable.ic_action_headphones,R.drawable.ic_action_add_group,R.drawable.ic_action_about};
